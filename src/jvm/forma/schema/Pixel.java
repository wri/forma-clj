...
public class Pixel implements org.apache.thrift.TBase<Pixel, Pixel._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Pixel");
  ...
  private static final org.apache.thrift.protocol.TField SAMPLE_FIELD_DESC = new org.apache.thrift.protocol.TField("sample", org.apache.thrift.protocol.TType.I32, (short)6);
  ...
  static {
    schemes.put(StandardScheme.class, new PixelStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PixelTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Pixel.class, metaDataMap);
  }
  ...
  public Pixel setDataset(String dataset) {
    this.dataset = dataset;
    return this;
  }
  ...
  public Pixel setTres(String tres) {
    this.tres = tres;
    return this;
  }
  ...
  public Pixel setSres(String sres) {
    this.sres = sres;
    return this;
  }
  ...
  public Pixel setSample(int sample) {
    this.sample = sample;
    setSampleIsSet(true);
    return this;
  }
  ...
  public Pixel setData(Data data) {
    this.data = data;
    return this;
  }
  ...
  public Pixel setDate(String date) {
    this.date = date;
    return this;
  }
  ...
  private static class PixelStandardSchemeFactory implements SchemeFactory {
    public PixelStandardScheme getScheme() {
      return new PixelStandardScheme();
    }
  }

  private static class PixelStandardScheme extends StandardScheme<Pixel> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Pixel struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Pixel struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PixelTupleSchemeFactory implements SchemeFactory {
    public PixelTupleScheme getScheme() {
      return new PixelTupleScheme();
    }
  }

  private static class PixelTupleScheme extends TupleScheme<Pixel> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Pixel struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Pixel struct) throws org.apache.thrift.TException {

...
public class FormaSeries implements TBase<FormaSeries, FormaSeries._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("FormaSeries");

  private static final TField VALUES_FIELD_DESC = new TField("values", TType.LIST, (short)1);

  public List<FormaValue> values;
  ...
  static {
    ...
    tmpMap.put(_Fields.VALUES, new FieldMetaData("values", TFieldRequirementType.DEFAULT, 
        new ListMetaData(TType.LIST, 
            new StructMetaData(TType.STRUCT, FormaValue.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    FieldMetaData.addStructMetaDataMap(FormaSeries.class, metaDataMap);
  }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.values = new ArrayList<FormaValue>(_list12.size);
              for (int _i13 = 0; _i13 < _list12.size; ++_i13)
              {
                FormaValue _elem14;
                _elem14 = new FormaValue();
                _elem14.read(iprot);
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.values != null) {
      oprot.writeFieldBegin(VALUES_FIELD_DESC);
      {
        ...
        for (FormaValue _iter15 : this.values)
        {
          _iter15.write(oprot);
        }
        oprot.writeListEnd();

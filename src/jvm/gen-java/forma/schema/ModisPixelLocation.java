...
public class ModisPixelLocation implements TBase<ModisPixelLocation, ModisPixelLocation._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ModisPixelLocation");
  ...
  private static final TField SAMPLE_FIELD_DESC = new TField("sample", TType.I32, (short)4);
  private static final TField LINE_FIELD_DESC = new TField("line", TType.I32, (short)5);
  ...
  static {
    ...
    tmpMap.put(_Fields.TILE_V, new FieldMetaData("tileV", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.I32)));
    tmpMap.put(_Fields.SAMPLE, new FieldMetaData("sample", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.I32)));
    tmpMap.put(_Fields.LINE, new FieldMetaData("line", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.I32)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    FieldMetaData.addStructMetaDataMap(ModisPixelLocation.class, metaDataMap);
  }
  ...
  /** Returns true if field sample is set (has been asigned a value) and false otherwise */
  ...
  /** Returns true if field line is set (has been asigned a value) and false otherwise */
  ...
  public int compareTo(ModisPixelLocation other) {
    ...
    if (isSetSample()) {
      lastComparison = TBaseHelper.compareTo(this.sample, typedOther.sample);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetLine()) {
      lastComparison = TBaseHelper.compareTo(this.line, typedOther.line);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }

...
(defmain ModisTimeseries
  ""
  [pail-path output-path s-res t-res dataset & {:keys [sinkmode] :or {sinkmode :keep}}]
...
(defn aggregate-fires  "Converts the datestring into a time period based on the supplied
  temporal resolution."
  [src t-res]

...
(let [test-gadm [["1000" 1 1 1 1 5]
                 ...
                 ["1000" 1 1 1 8 6]
                 ["1000" 1 1 1 9 6]]
      test-rain [[1 1 1 1 "2005-12-01" 12.0]
                 [1 1 1 2 "2005-12-01" 2.0]
                 [1 1 1 2 "2005-12-01" 4.0]
                 [1 1 1 2 "2005-12-01" 2.0]
                 [1 1 1 2 "2005-12-01" 4.0]
                 [1 1 1 2 "2005-12-01" 2.0]
      ...
      results [[5 "2005-12-01" 7.5555553]
               [5 "2006-01-01" 15.0]
               [5 "2006-02-01" 16.0]
               [5 "2006-03-01" 16.0]
               [6 "2006-03-01" 16.0]]]
  (fact
    (fact?- results (run-rain :gadm-src :rain-src))
    (provided

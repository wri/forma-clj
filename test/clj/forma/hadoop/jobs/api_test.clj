...
(fact "Check `prob-series->tsv-api"
  (prob-series->tsv-api est-map sample-forma-data sample-static-data)
  => (produces-some
      [[9.99791666666666 101.54412568476158 "IDN" 15319 "2005-12-19" "2005" 50]
       [9.99791666666666 101.54412568476158 "IDN" 15319 "2006-01-01" "2006" 50]
       [9.99791666666666 101.54412568476158 "IDN" 15319 "2006-01-17" "2006" 51]
       [9.99791666666666 101.54412568476158 "IDN" 15319 "2006-02-02" "2006" 53]
       [9.99791666666666 101.54412568476158 "IDN" 15319 "2006-02-18" "2006" 56]
       [9.99791666666666 101.54412568476158 "IDN" 15319 "2006-03-06" "2006" 58]]))
...
(fact "Check `mk-tsv`"
  (let [forma-path "/tmp/forma"
    ...
    => (produces-some [["9.99791666666666\t101.54412568476158\t15319\t2006-01-01\t50"]])))
